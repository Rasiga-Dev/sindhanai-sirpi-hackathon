      ...
      <div className="px-6 py-16 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed text-lg">
            SINDHANAI SIRPI is where ideas meet innovation. It’s a vibrant space for school students to solve real-world problems, gain mentorship, and showcase their skills.
          </p>


          {/* Extra Content */}
          <p className="text-gray-600 text-base">
            This initiative encourages students from schools to bring forward their creative solutions to everyday problems. Through hands-on experience, guided mentorship, and collaborative teamwork, participants grow their technical and leadership abilities — preparing them to be the changemakers of tomorrow.
          </p>

          <p className="text-gray-600 text-base">
            Whether you're building a groundbreaking app, designing a sustainable solution, or improving community services, Sindhanai Sirpi is your platform to shine. The program is not just a competition — it's a movement that celebrates creativity, innovation, and the spirit of problem-solving.
          </p>

    ...
    <div className="space-y-4 mb-10">
      ...
      <div className="bg-red-800 text-white py-3 overflow-hidden rounded-lg">
        <div className="animate-marquee whitespace-nowrap text-sm sm:text-base">
          ...
          <span className="mx-4">📅 Registration closes: Jan, 2026</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12">
        ...
        {/* Buttons Section */}
         <div className="md:col-span-3 flex flex-col items-center justify-center space-y-4 bg-red-800 text-white p-6 md:p-12 relative overflow-hidden">
          {[
            // { text: 'Request Information', link: '/request-info' },
            { text: 'Apply Now', link: '/signup' },
            { text: 'Log In', link: '/school-login' }
          ].map((btn, index) => (
            <button
              key={index}
              className="text-red-800 w-full text-center font-bold text-xl border bg-white py-2 rounded"
              style={buttonStyle}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                "School Registration -> Guide teacher Registeration & Idea Submission",
                "Bootcamp Training & Expert Mentorship",
                "Final Presentation & Prize Awards",
              ].map((step, index) => (
                <motion.div
                  key={index}

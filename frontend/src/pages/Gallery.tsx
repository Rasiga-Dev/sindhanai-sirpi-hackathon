...
export function Gallery() {
  ...
  const galleryItems = [
...

    {
     ...
     {
      image: "principal-madurai.jpg",
      title: "Principal Meeting – Madurai District",
      description: "The Sindhanai Sirpi Hackathon Principal Meeting for Madurai district was successfully held on 15/09/2025.During the meeting, principals were provided with clear guidelines about the hackathon process. They were encouraged to join the official WhatsApp group for timely updates and communication. Additionally, principals were requested to ensure that their schools complete the registration form to actively participate in the Sindhanai Sirpi Hackathon.",
      details: ""
    },
     {
      image: "principal-thoothukudi.jpg",
      title: "Principal Meeting – Thoothukudi District",
      description: "The Sindhanai Sirpi Hackathon Principal Meeting for Madurai district was successfully held on 22/09/2025.During the meeting, principals were provided with clear guidelines about the hackathon process. They were encouraged to join the official WhatsApp group for timely updates and communication. Additionally, principals were requested to ensure that their schools complete the registration form to actively participate in the Sindhanai Sirpi Hackathon.",
      details: ""
    },
     {
      image: "principal-tenkasi.jpg",
      title: "Principal Meeting – Tenkasi District",
      description: "The Sindhanai Sirpi Hackathon Principal Meeting for Tenkasi district was successfully held on 23/09/2025.During the meeting, principals were provided with clear guidelines about the hackathon process. They were encouraged to join the official WhatsApp group for timely updates and communication. Additionally, principals were requested to ensure that their schools complete the registration form to actively participate in the Sindhanai Sirpi Hackathon.",
      details: ""
    }

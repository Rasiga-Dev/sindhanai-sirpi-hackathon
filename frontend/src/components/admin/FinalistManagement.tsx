...
console.log("VITE_BASE_URL from config:", VITE_BASE_URL);
    ...
    const fetchFinalists = async () => {
        try {
            const res = await axios.get(`${VITE_BASE_URL}/admin/top-finalists`);
    ...
    const handleNotify = async (project: Finalist) => {
        try {
            await axios.post(`${VITE_BASE_URL}/admin/notify-finalist/${project.projectId}`);
                                ...
                                <div className="flex justify-center gap-3 mt-4">
                                    <button
                                        onClick={async () => {
                                            ...
                                            try {
                                                await axios.post(`${VITE_BASE_URL}/admin/accept-finalist/${selectedProject.projectId}`, {
                                                    rank: selectedRank,
